    ...
    <div class="header w-full py-2 top-0 justify-between static">
      <div class="flex justify-between items-center w-full px-4">
        ...
        <div class="relative flex items-center bg-white rounded-md w-1/2 lg:w-2/5 mx-5 hidden md:flex">
          ...
          <input 
            ...
            class="py-3 border-0 outline-0 rounded-md px-4 ml-4 w-full text-sm"
          >
        </div>
        <div class="md:hidden">
      ...
      <div v-if="isMobileMenuOpen" class="md:hidden">
        <div class="flex flex-col items-center px-4 py-2 space-y-2 text-white">
          ...
          <div v-if="!isAuthenticated" class="w-full text-center">
            <RouterLink to="/signup" class="w-full text-center">SignUp</RouterLink>
          </div>
          <div v-if="!isAuthenticated" class="w-full text-center">
            <RouterLink to="/login" class="w-full text-center">Login</RouterLink>
          </div>
