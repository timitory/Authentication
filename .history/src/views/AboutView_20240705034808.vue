              ...
              <form @submit.prevent="Register">
                  ...
                  <div class="mb-4">
                      <div class="relative">
                          ...
                          <input type="currentpassword" v-model="confirmPassword" class="block w-full rounded-lg pl-10 py-3 text-sm text-gray-800 border border-gray-300 focus:outline-none focus:border-blue-500" placeholder="Repeat Password">
                      </div>
